...
public class PnjKaramel extends Pnj {
	...
	public PnjKaramel() {
		...
		pnj_objet = new ObjetQuete("L'armure légendaire");
		...
		liste_quetes.add(new Quete("Quête 1 de Karamel", 
								   ...
								   new ObjetQuete("Le Bouclier de Perlin"),
								   "EXP +20", false));
		liste_quetes.add(new Quete("Quête 2 de Karamel", 
								   ...
								   new ObjetQuete("Le journal d'indice"),
								   "EXP +20", false));
		liste_quetes.add(new Quete("Quête 3 de Karamel", 
								   ...
								   new ObjetQuete("La tête du boss1"),
								   "EXP +30", false));
		liste_quetes.add(new Quete("Quête 4 de Karamel", 
								   "J'aimerai décorer la tombe de mes parents avec les roseaux de la région. Ils poussent dans le Sud, au bord d'un lac. \n Ramène moi un bouquet.", 
								   "Les roseaux sont magnifiques, les tombes seront bien décorées. \n Merci.",
								   new ObjetQuete("Un bouquet de roseaux"),
								   "EXP +10", false));
		liste_quetes.add(new Quete("Quête 5 de Karamel", 
								   ...
								   new ObjetQuete("La preuve du massacre"),
								   "EXP +30", false));
		...
		liste_quetes.add(new Quete("Quête 6 de Karamel", 
				   				   ...
				   				   new ObjetQuete("L'ancienne statue de la prospérité"),
				   				   "EXP +20", false));
