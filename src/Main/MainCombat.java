...
public class MainCombat {
	...
	public static void main(String[] Args) throws InterruptedException {
		...
		Equipement[] artefactAnduyn= {epee};
		Equipement[] artefactThrall= {epee, bouclier};
		Equipement[] artefactLegolas= {epee, potiondevie};

		//Personnages
		Equipe equipe=new Equipe();
		Personnage Anduyn=new Humain("Anduyn",new Coord(6,8), artefactAnduyn, true);
		Personnage Thrall=new Orc("Thrall",new Coord(6,8), artefactThrall, false);
		Personnage Legolas= new Elfe("Legolas",new Coord(6,8), artefactLegolas, false);
